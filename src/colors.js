...
export const colorsBgLight = {
  ...
  info: "bg-purple-500 borde-purple-500 text-white",
};
...
export const colorsOutline = {
  ...
  info: [colorsText.info, "border-purple-500"],
};
...
export const getButtonColor = (
  ...
  const colors = {
    ring: {
      ...
      info: "ring-purple-300 dark:ring-purple-900",
    },
    active: {
      white: "bg-gray-100",
      ...
      info: "bg-purple-700 dark:bg-purple-800",
    },
    bg: {
      white: "bg-white text-black",
      ...
      info: "bg-purple-600 dark:bg-purple-900 text-white",
    },
    bgHover: {
      ...
      info: "hover:bg-purple-700 hover:border-purple-700 hover:dark:bg-purple-800 hover:dark:border-purple-800",
    },
    borders: {
      white: "border-white",
      ...
      info: "border-purple-600 dark:border-purple-900",
    },
    text: {
    ...
    outlineHover: {
      ...
      info: "hover:bg-purple-600 hover:text-white hover:dark:text-white hover:dark:border-purple-600",
    },
  };
